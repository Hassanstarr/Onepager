...
function Footer() {
  return (
    <footer className="bg-[#2bb6b6] py-10">
      <div className="mx-auto w-full max-w-7xl px-3.75">
        <div className="flex items-center justify-between">
          ...
          <ul className="m-0 flex list-none items-center gap-3 p-0">
            <li>
              <a
                href="#"
                className="flex h-15 w-15 items-center justify-center rounded-full border border-white text-white transition hover:bg-white hover:text-[#2bb6b6]"
              >
                <FaFacebookF size={30} />
              </a>
            </li>
