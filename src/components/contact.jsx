    ...
    return(
        <div id='Contact' className="w-full py-15 flex items-center justify-center flex-col bg-[#333333]">
            ...
            <div className="page-container grid grid-cols-1 lg:grid-cols-2 gap-10 w-full max-w-6xl mb-20">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 md:gap-5 mb-15" onSubmit={handleSubmit}>
                   <div>
                        <div className="mb-2.5 flex">
                            <div className="flex w-14.25 shrink-0 items-center justify-center border border-r-0 bg-white border-[#eaeaea] text-[#848484]">
                            <FaUser />
                            </div>
                            ...
                            className="block w-full rounded-none bg-white border border-[#eaeaea] p-4.5 font-['Courier_New'] text-[14px] text-[#848484] outline-none placeholder:text-[#848484]"
                            />
                        </div>

                        <div className="mb-2.5 flex">
                            <div className="flex w-14.25 shrink-0 items-center justify-center bg-white border border-r-0 border-[#eaeaea] text-[#848484]">
                            <FaEnvelope />
                            </div>
                    ...
                    <div>
                        ...
                        required
                        placeholder="Message"
                        className="mb-2.5 box-border block h-32 w-full resize-none rounded-none border border-[#eaeaea] bg-white p-4.5 font-['Courier_New'] text-[14px] text-[#848484] outline-none placeholder:text-[#848484]"
                        ></textarea>

                        <button
                        type="submit"
                        disabled={status === 'loading'}
                        className="mb-2.5 h-14 block cursor-pointer w-full  bg-[#1ab5b3]  text-center font-['Courier_New'] text-[14px] uppercase text-white disabled:opacity-50"
                        >
