...
function About() {
    ...
    return(
        <div id="About" className='pt-20'>
            ...
            <div className="w-full page-container grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="w-full page-container mt-10">
                <div className="my-w0 text-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    {aboutData.map((stats, index) => (
                        <div key={index} className="flex flex-col items-center justify-center px-1 md:px-2.5 py-12.5 mb-6.25 text-center border border-[#e4e4e4]">
                            <div className="mb-9 text-[44px] text-[#2bb6b6]">
                                {stats.icon}
                            </div>
