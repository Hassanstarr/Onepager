                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-auto hidden md:block">
                        <ul className="flex items-center gap-2">
                            ...
                            <li><a href="#Team" className="relative px-4 py-3 font-['Courier_New'] text-[18px] uppercase text-[#010000] transition-all duration-170 ease-in-out hover:bg-[#2bb6b6] hover:text-white">Team</a></li>
                            ...
                            <li><a href="#Contact" className="relative px-4 py-3 font-['Courier_New'] text-[18px] uppercase text-[#010000] transition-all duration-170 ease-in-out hover:bg-[#2bb6b6] hover:text-white">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
